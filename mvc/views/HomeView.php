    ...
    <div class="row mt-4 custom_row_mt4">
      ...
      <div class="group-product custom_group">
        <div class="row custom_row">
          ...
          ?>
            <div class="col-6 col-sm-6 col-md-6 col-lg-6 custom-col-brand ">
              <div class="card custom-card-brand">

                <img class="card-img custom-brand-card-image custom-image-size" src="<?php echo "http://localhost:88/web_mvc/admin" . $row["brandImage"] ?>" alt="Bologna" style="object-fit: cover;">
                ...
                <h4 class="card-title custom-item-brand-text-color"><?php echo $row["brandName"]; ?></h4>
                    <h6 class="card-subtitle mb-2 custom-item-brand-text-color">Mô tả brand</h6>
                    <p class="card-text"></p>
          ...
          ?>
            <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 custom_col" style="display: none">
              <div class="card custom_card">
                <a class="custom-item-color" href="#" onclick="window.location.replace('http://localhost:88/ProjectWeb/Chitietsanpham/Product/<?php echo $row["productId"] ?>');">
                  <img src="<?php echo "http://localhost:88/web_mvc/admin" . $row["image"] ?>" class="card-img-top custom_col_image custom-image-size custom-hover-image" src="http://via.placeholder.com/280x280" height="auto" width="100%">
