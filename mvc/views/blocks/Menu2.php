    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown custom-width">
          <a href="http://localhost:88/ProjectWeb/AllProduct"  class="nav-link custom-font-menu" id="navbarDropdown">Cửa Hàng</a>
        ...
        <li class="nav-item dropdown custom-width account">
          <a class="nav-link custom-font-menu da-dang-nhap custom-login" href="http://localhost:88/ProjectWeb/Login">Đăng Nhập</a>
          <div class="dropdown-content custom-dropdown">
