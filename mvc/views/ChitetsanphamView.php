        ...
        ?>
          ...
          <div class="row custom_row_thongtinsp">
            ...
            <div class="col-md-6 col-12 custom_col custom_col_img">
              <img id="expandedImg" class="image" src="<?php echo "https://mtpshop.000webhostapp.com/AdminWeb/admin" . $row["image"] ?>" width="400px" height="300px">
              <!-- anh thu vien -->
              <div class="row row-gallery">
                <div class="col-3 col-thumbnail">
                  <img class="sub-image" src="<?php echo "https://mtpshop.000webhostapp.com/AdminWeb/admin" . $row["image"] ?>" onclick="myFunction(this);">
                </div>
                <?php
                $i = 0;
                ...
                ?>
                  <div class="col-3 col-thumbnail">
                    <img class="sub-image" src="<?php echo "https://mtpshop.000webhostapp.com/AdminWeb/admin" . $subImage["path"] ?>" onclick="myFunction(this);">
                  </div>
                <?php
                }
                ?>
