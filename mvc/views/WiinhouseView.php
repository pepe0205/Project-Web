              ...
              <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 custom_col" style="display: none">
                <div class="card custom_card">
                  <a class="custom-item-color" href="#" onclick="window.location.replace('http://localhost:88/ProjectWeb/Chitietsanpham/Product/<?php echo $row["productId"] ?>');">
                    <img src="<?php echo "http://localhost:88/web_mvc/admin" . $row["image"] ?>" class="card-img-top custom_col_image custom-image-size" src="http://via.placeholder.com/280x280" height="auto" width="100%">
                    <div class="card-body custom_card_body">
                      <p class="card-text">
                        <p class="custom-productname"><?php echo $row["productName"];?></p>
                        <?php
                        echo "<br>";
