        ...
        <div class="d-flex justify-content-center form_container">
          ...
          ?>
            ...
            <div class="form-group">
                            ...
                            <input name="email" type="text" class="form-control input_pass required email-sg" placeholder="<?php echo $row["email"]; ?>" disabled>
            </div>
            <div class="form-group">
                            <p>Số điện thoại:<p>

                            <!--<label>Số Điện Thoại</label>-->
                            <input name="phone" type="text" class="form-control input_pass phone-sg" placeholder="<?php echo $row["phoneNumber"]; ?>"disabled>
                        </div>
   ...
   var cipher = sessionStorage.getItem('userInfo');
      if(cipher != null) {
        ...
        $('.edit-btn').click(function (e) {         
              window.location.replace("http://localhost:88/ProjectWeb/EditProfile/User/"+obj.id);
        }) 
